...
Número: 2817
Ficheiro: EliminarFornecedor.java
Data: 16.07.2025
--------------------------------------*/
import javax.swing.*;
...
public class EliminarFornecedor extends JFrame
{
    private PainelCentro centro;
    private PainelSul sul;
    
    public EliminarFornecedor()
    {
        super("Pesquisas do Fornecedor Para Eliminacao");
            ...
            {   
                ...
                {    
                    ...
                    if(opcao == JOptionPane.YES_OPTION)
                    {
                        ...
                        new FornecedorFile().eliminarDados(modelo);
                        dispose();
                    }
                    else    
