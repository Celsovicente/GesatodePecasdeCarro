...
Número: 35217
Ficheiro: PesquisarFornecedor.java
Data: 16.07.2025
--------------------------------------*/
import javax.swing.*;
...
public class PesquisarFornecedor extends JFrame
{
        ...
        public void actionPerformed(ActionEvent event)
        {
            ...
            {    
                if(centro.getTipoPesquisa() == 1)
                    FornecedorFile.pesquisarPorId(centro.getIdProcurado());
                else if(centro.getTipoPesquisa() == 2)
                    FornecedorFile.pesquisarPorNome(centro.getNomeProcurado());
            }
            else 
                dispose();
        }
